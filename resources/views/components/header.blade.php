<!-- TODO Fix the hover on departments -->

<body>
    <header id="header">
        <div class="logo">
            <a>
                <img id="scroll-image" src="/images/white-logo.svg" alt="Logo">
            </a>
        </div>
        <nav id="nav">
            <a id="" href=""> About Us </a>
            <a id="" href=""> Services </a>
            <a id="departments-box" href="#"> Departments </a>
            <a id="" href=""> Our Work </a>
            <a id="" href=""> Events </a>
            <a id="" href=""> Contact Us </a>
        </nav>
    </header>
